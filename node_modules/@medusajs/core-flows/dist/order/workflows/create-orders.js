...
const cart_1 = require("../../definition/cart");
...
exports.createOrdersWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.createOrdersWorkflowId, (input) => {
    ...
    const [salesChannel, region, customerData] = (0, workflows_sdk_1.parallelize)((0, cart_1.findSalesChannelStep)({
        salesChannelId: input.sales_channel_id,
    }), (0, cart_1.findOneOrAnyRegionStep)({
        regionId: input.region_id,
    }), (0, cart_1.findOrCreateCustomerStep)({
        customerId: input.customer_id,
        email: input.email,
    }), (0, cart_1.validateVariantsExistStep)({ variantIds }));
    const variants = (0, cart_1.getVariantsStep)({
    ...
    (0, cart_1.confirmInventoryStep)(confirmInventoryInput);
    ...
    const priceSets = (0, cart_1.getVariantPriceSetsStep)({
        variantIds,
