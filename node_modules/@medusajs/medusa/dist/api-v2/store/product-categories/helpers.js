...
var refetchCategory = function (categoryId, scope, fields, filterableFields) {
    if (filterableFields === void 0) { filterableFields = {}; }
    return __awaiter(void 0, void 0, void 0, function () {
        var remoteQuery, queryObject, categories;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    queryObject = (0, utils_1.remoteQueryObjectFromString)({
                        ...
                        variables: {
                            filters: __assign(__assign({}, filterableFields), { id: categoryId }),
                        },
                        fields: fields,
                    });
...
var applyCategoryFilters = function (req, res, next) {
    if (!req.filterableFields) {
        req.filterableFields = {};
    }
    req.filterableFields = __assign(__assign({}, req.filterableFields), { is_active: true, is_internal: false });
    next();
};
