...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, context, queryObject, _a, products, metadata;
        ...
        switch (_b.label) {
            case 0:
                ...
                queryObject = (0, utils_1.remoteQueryObjectFromString)({
                    entryPoint: "product",
                    variables: __assign(__assign({ filters: req.filterableFields }, req.remoteQueryConfig.pagination), context),
                    fields: req.remoteQueryConfig.fields,
                });
                return [4 /*yield*/, remoteQuery(queryObject)];
            case 1:
                _a = _b.sent(), products = _a.rows, metadata = _a.metadata;
                res.json({
                    products: products,
