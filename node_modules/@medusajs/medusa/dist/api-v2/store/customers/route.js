...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, query, _a, customer_1, createCustomers, customersData, result, customer;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = __read.apply(void 0, [_b.sent(), 1]), customer_1 = _a[0];
                res.status(200).json({ customer: customer_1 });
                return [2 /*return*/];
            case 2:
            ...
            case 3:
                ...
                return [4 /*yield*/, (0, helpers_1.refetchCustomer)(result.id, req.scope, req.remoteQueryConfig.fields)];
            case 4:
                customer = _b.sent();
