...
function applyDefaultFilters(filtersToApply) {
    ...
    return function (req, _, next) { return __awaiter(_this, void 0, void 0, function () {
        var _a, _b, _c, filter, filterValue, valueToApply;
        var e_1, _d;
        return __generator(this, function (_e) {
            try {
                for (_a = __values(Object.entries(filtersToApply)), _b = _a.next(); !_b.done; _b = _a.next()) {
                    _c = __read(_b.value, 2), filter = _c[0], filterValue = _c[1];
                    ...
                    if (typeof filterValue === "function") {
                        ...
                        valueToApply = filterValue(req.filterableFields, req.remoteQueryConfig.fields);
                    }
                    ...
                    if ((0, utils_1.isObject)(valueToApply)) {
                        req.filterableFields[filter] = __assign(__assign({}, (req.filterableFields[filter] || {})), valueToApply);
                    }
