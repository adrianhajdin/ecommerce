...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, result, errors, taxRegion;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, helpers_1.refetchTaxRegion)(result[0].id, req.scope, req.remoteQueryConfig.fields)];
            case 2:
                taxRegion = _b.sent();
...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, _a, tax_regions, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                _a = _b.sent(), tax_regions = _a.rows, metadata = _a.metadata;
                res.status(200).json({
