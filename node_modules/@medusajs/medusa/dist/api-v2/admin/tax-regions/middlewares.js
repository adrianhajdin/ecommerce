...
exports.adminTaxRegionRoutesMiddlewares = [
    ...
    },
    {
        ...
        matcher: "/admin/tax-regions",
        middlewares: [
            (0, validate_body_1.validateAndTransformBody)(validators_1.AdminCreateTaxRegion),
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetTaxRegionsParams, QueryConfig.listTransformQueryConfig),
        ],
    },
    {
        method: "GET",
    ...
    },
    {
        ...
        middlewares: [
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetTaxRegionParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
];
