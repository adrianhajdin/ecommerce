...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, queryObject, _a, product_types, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), product_types = _a.rows, metadata = _a.metadata;
                res.json({
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var input, _a, result, errors, productType;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                input = [req.validatedBody];
                return [4 /*yield*/, (0, core_flows_1.createProductTypesWorkflow)(req.scope).run({
