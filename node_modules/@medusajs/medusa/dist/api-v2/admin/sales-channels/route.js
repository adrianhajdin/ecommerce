...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, queryObject, _a, sales_channels, metadata;
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var salesChannelsData, _a, errors, result, salesChannel;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                _a = _b.sent(), errors = _a.errors, result = _a.result;
                if (Array.isArray(errors) && errors[0]) {
                    throw errors[0].error;
                }
                return [4 /*yield*/, (0, helpers_1.refetchSalesChannel)(result[0].id, req.scope, req.remoteQueryConfig.fields)];
            case 2:
