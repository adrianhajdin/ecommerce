...
exports.adminSalesChannelRoutesMiddlewares = [
    ...
    },
    {
        ...
        matcher: "/admin/sales-channels",
        middlewares: [
            (0, validate_query_1.validateAndTransformQuery)(validators_2.AdminGetSalesChannelsParams, QueryConfig.listTransformQueryConfig),
    ...
    },
    {
        ...
        middlewares: [
            (0, validate_query_1.validateAndTransformQuery)(validators_2.AdminGetSalesChannelParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        method: ["POST"],
        matcher: "/admin/sales-channels",
        middlewares: [
            (0, validate_body_1.validateAndTransformBody)(validators_2.AdminCreateSalesChannel),
            (0, validate_query_1.validateAndTransformQuery)(validators_2.AdminGetSalesChannelParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        ...
        matcher: "/admin/sales-channels/:id",
        middlewares: [
            (0, validate_body_1.validateAndTransformBody)(validators_2.AdminUpdateSalesChannel),
            (0, validate_query_1.validateAndTransformQuery)(validators_2.AdminGetSalesChannelParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
