...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, queryObject, _a, shipping_options, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), shipping_options = _a.rows, metadata = _a.metadata;
                res.json({
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var shippingOptionPayload, workflow, _a, result, errors, shippingOption;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                shippingOptionPayload = req.validatedBody;
                workflow = (0, core_flows_1.createShippingOptionsWorkflow)(req.scope);
