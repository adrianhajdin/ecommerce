...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, queryObject, _a, promotions, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), promotions = _a.rows, metadata = _a.metadata;
                res.json({
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var createPromotions, promotionsData, _a, result, errors, promotion;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                createPromotions = (0, core_flows_1.createPromotionsWorkflow)(req.scope);
                promotionsData = [req.validatedBody];
                return [4 /*yield*/, createPromotions.run({
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, helpers_1.refetchPromotion)(result[0].id, req.scope, req.remoteQueryConfig.fields)];
            case 2:
                promotion = _b.sent();
