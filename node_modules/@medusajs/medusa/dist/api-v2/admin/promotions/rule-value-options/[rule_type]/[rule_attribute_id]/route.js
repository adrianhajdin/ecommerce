...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, ruleType, ruleAttributeId, queryConfig, remoteQuery, rows, values;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.params, ruleType = _a.rule_type, ruleAttributeId = _a.rule_attribute_id;
                queryConfig = utils_2.ruleQueryConfigurations[ruleAttributeId];
                remoteQuery = req.scope.resolve(utils_1.ContainerRegistrationKeys.REMOTE_QUERY);
                (0, utils_2.validateRuleType)(ruleType);
                (0, utils_2.validateRuleAttribute)(ruleType, ruleAttributeId);
