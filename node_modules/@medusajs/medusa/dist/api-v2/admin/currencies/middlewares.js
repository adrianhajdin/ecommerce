...
exports.adminCurrencyRoutesMiddlewares = [
    ...
    },
    {
        ...
        matcher: "/admin/currencies",
        middlewares: [
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetCurrenciesParams, QueryConfig.listTransformQueryConfig),
        ],
    },
    {
        method: ["GET"],
        ...
        middlewares: [
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetCurrencyParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
];
