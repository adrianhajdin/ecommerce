...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, queryObject, _a, priceLists, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), priceLists = _a.rows, metadata = _a.metadata;
                res.json({
                    price_lists: priceLists.map(function (priceList) { return (0, helpers_1.transformPriceList)(priceList); }),
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var workflow, _a, result, errors, price_list;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, helpers_1.fetchPriceList)(result[0].id, req.scope, req.remoteQueryConfig.fields)];
            case 2:
                price_list = _b.sent();
                res.status(200).json({ price_list: price_list });
                return [2 /*return*/];
        }
    });
}); };
