...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, helpers_1.fetchPriceList)(req.params.id, req.scope, req.remoteQueryConfig.fields)];
            case 1:
                price_list = _a.sent();
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, workflow, errors, price_list;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                ...
                return [4 /*yield*/, workflow.run({
                        input: { price_lists_data: [__assign(__assign({}, req.validatedBody), { id: id })] },
                        throwOnError: false,
                    })];
            case 1:
