...
exports.adminFulfillmentSetsRoutesMiddlewares = [
    ...
    },
    {
        ...
        middlewares: [
            (0, validate_body_1.validateAndTransformBody)(validators_1.AdminCreateFulfillmentSetServiceZonesSchema),
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminFulfillmentSetParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        method: ["DELETE"],
    ...
    },
    {
        ...
        matcher: "/admin/fulfillment-sets/:id/service-zones/:zone_id",
        middlewares: [
            (0, validate_body_1.validateAndTransformBody)(validators_1.AdminUpdateFulfillmentSetServiceZonesSchema),
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminFulfillmentSetParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        ...
        matcher: "/admin/fulfillment-sets/:id/service-zones/:zone_id",
        middlewares: [
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminServiceZonesParams, QueryConfig.retrieveServiceZoneTransformQueryConfig),
        ],
    },
];
