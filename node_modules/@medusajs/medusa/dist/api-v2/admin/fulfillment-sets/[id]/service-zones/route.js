...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var workflowInput, errors, fulfillmentSet;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, core_flows_1.createServiceZonesWorkflow)(req.scope).run({
                        input: workflowInput,
                        throwOnError: false,
                    })];
            case 1:
                ...
                return [4 /*yield*/, (0, helpers_1.refetchFulfillmentSet)(req.params.id, req.scope, req.remoteQueryConfig.fields)];
            case 2:
                fulfillmentSet = _a.sent();
