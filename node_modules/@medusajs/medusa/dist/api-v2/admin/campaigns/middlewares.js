...
exports.adminCampaignRoutesMiddlewares = [
    ...
    },
    {
        ...
        matcher: "/admin/campaigns",
        middlewares: [
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetCampaignsParams, QueryConfig.listTransformQueryConfig),
        ],
    },
    {
        method: ["POST"],
        matcher: "/admin/campaigns",
        middlewares: [
            (0, validate_body_1.validateAndTransformBody)(validators_1.AdminCreateCampaign),
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetCampaignParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        method: ["GET"],
    ...
    },
    {
        ...
        matcher: "/admin/campaigns/:id",
        middlewares: [
            (0, validate_body_1.validateAndTransformBody)(validators_1.AdminUpdateCampaign),
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetCampaignParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
];
