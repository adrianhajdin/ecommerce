...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, query, _a, campaigns, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), campaigns = _a.rows, metadata = _a.metadata;
                res.json({
                    campaigns: campaigns,
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var createCampaigns, campaignsData, _a, result, errors, campaign;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, helpers_1.refetchCampaign)(result[0].id, req.scope, req.remoteQueryConfig.fields)];
            case 2:
                campaign = _b.sent();
