...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, queryObject, _a, rule_types, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), rule_types = _a.rows, metadata = _a.metadata;
                res.json({
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var workflow, ruleTypesData, _a, result, errors, ruleType;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, helpers_1.refetchRuleType)(result[0].id, req.scope, req.remoteQueryConfig.fields)];
            case 2:
                ruleType = _b.sent();
                res.status(200).json({
                    rule_type: ruleType,
