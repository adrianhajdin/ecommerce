...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, variables, queryObject, _a, file;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                remoteQuery = req.scope.resolve(utils_1.ContainerRegistrationKeys.REMOTE_QUERY);
                variables = { id: req.params.id };
                queryObject = (0, utils_2.remoteQueryObjectFromString)({
                    entryPoint: "file",
                    variables: variables,
            ...
            case 1:
                _a = __read.apply(void 0, [_b.sent(), 1]), file = _a[0];
                if (!file) {
                    throw new utils_1.MedusaError(utils_1.MedusaError.Types.NOT_FOUND, "File with id: ".concat(req.params.id, " not found"));
                }
...
var DELETE = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, (0, core_flows_1.deleteFilesWorkflow)(req.scope).run({
                        input: { ids: [id] },
                        throwOnError: false,
                    })];
            case 1:
