...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, queryObject, _a, reservations, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), reservations = _a.rows, metadata = _a.metadata;
                res.json({
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var input, _a, result, errors, reservation;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                input = [req.validatedBody];
                return [4 /*yield*/, (0, core_flows_1.createReservationsWorkflow)(req.scope).run({
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, helpers_1.refetchReservation)(result[0].id, req.scope, req.remoteQueryConfig.fields)];
            case 2:
                reservation = _b.sent();
