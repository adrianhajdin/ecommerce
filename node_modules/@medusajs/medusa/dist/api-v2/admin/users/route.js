...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var input, result, user, jwt_secret, token;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                // If `actor_id` is present, the request carries authentication for an existing user
                if (req.auth.actor_id) {
                    throw new utils_1.MedusaError(utils_1.MedusaError.Types.INVALID_DATA, "Request carries authentication for an existing user");
                }
                input = {
                    input: {
                ...
                return [4 /*yield*/, (0, core_flows_1.createUserAccountWorkflow)(req.scope).run(input)];
            case 1:
                result = (_a.sent()).result;
                return [4 /*yield*/, (0, helpers_1.refetchUser)(req.auth.auth_user_id, req.scope, req.remoteQueryConfig.fields)];
            case 2:
                user = _a.sent();
                jwt_secret = req.scope.resolve(utils_1.ContainerRegistrationKeys.CONFIG_MODULE).projectConfig.jwt_secret;
                token = jsonwebtoken_1.default.sign(user, jwt_secret);
