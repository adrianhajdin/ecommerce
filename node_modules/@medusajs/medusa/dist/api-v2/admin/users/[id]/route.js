...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, id, query, _a, user;
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var workflow, input, result, user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, helpers_1.refetchUser)(req.params.id, req.scope, req.remoteQueryConfig.fields)];
            case 2:
                user = _a.sent();
                res.status(200).json({ user: user });
                return [2 /*return*/];
