...
exports.adminRegionRoutesMiddlewares = [
    ...
    },
    {
        ...
        matcher: "/admin/regions",
        middlewares: [
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetRegionsParams, QueryConfig.listTransformQueryConfig),
        ],
    },
    {
        method: ["GET"],
        ...
        middlewares: [
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetRegionParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        method: ["POST"],
        matcher: "/admin/regions",
        middlewares: [
            (0, validate_body_1.validateAndTransformBody)(validators_1.AdminCreateRegion),
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetRegionParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        ...
        matcher: "/admin/regions/:id",
        middlewares: [
            (0, validate_body_1.validateAndTransformBody)(validators_1.AdminUpdateRegion),
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetRegionParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
];
