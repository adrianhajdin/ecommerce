...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, helpers_1.refetchRegion)(req.params.id, req.scope, req.remoteQueryConfig.fields)];
            case 1:
                region = _a.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, helpers_1.refetchRegion)(result[0].id, req.scope, req.remoteQueryConfig.fields)];
            case 2:
                region = _b.sent();
                res.status(200).json({ region: region });
                return [2 /*return*/];
