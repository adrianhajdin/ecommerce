...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var shippingProfilePayload, _a, result, errors, shippingProfile;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                shippingProfilePayload = req.validatedBody;
                return [4 /*yield*/, (0, core_flows_1.createShippingProfilesWorkflow)(req.scope).run({
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, helpers_1.refetchShippingProfile)(result === null || result === void 0 ? void 0 : result[0].id, req.scope, req.remoteQueryConfig.fields)];
            case 2:
                shippingProfile = _b.sent();
...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, query, _a, shippingProfiles, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                _a = _b.sent(), shippingProfiles = _a.rows, metadata = _a.metadata;
                res.status(200).json({
