...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var input, _a, result, errors, batchResults;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                input = req.validatedBody;
                return [4 /*yield*/, (0, core_flows_1.batchProductsWorkflow)(req.scope).run({
                        input: input,
                        throwOnError: false,
                    })];
            case 1:
                ...
                return [4 /*yield*/, (0, helpers_1.refetchBatchProducts)(result, req.scope, req.remoteQueryConfig.fields)];
            case 2:
