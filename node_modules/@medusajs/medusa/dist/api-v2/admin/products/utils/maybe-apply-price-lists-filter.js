...
exports.maybeApplyPriceListsFilter = void 0;
var utils_1 = require("@medusajs/utils");
function maybeApplyPriceListsFilter() {
    var _this = this;
    return function (req, _, next) { return __awaiter(_this, void 0, void 0, function () {
        var filterableFields, priceListIds, queryObject, remoteQuery, variantIds, priceLists;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    priceListIds = filterableFields.price_list_id;
                ...
                case 1:
                    ...
                    priceLists.forEach(function (priceList) {
                        var _a;
                        (_a = priceList.prices) === null || _a === void 0 ? void 0 : _a.forEach(function (price) {
                            var _a, _b;
                            var variantId = (_b = (_a = price.price_set) === null || _a === void 0 ? void 0 : _a.variant) === null || _b === void 0 ? void 0 : _b.id;
                            if (variantId) {
                                variantIds.push(variantId);
                            }
                        });
                    });
                    filterableFields.variants = __assign(__assign({}, ((_a = filterableFields.variants) !== null && _a !== void 0 ? _a : {})), { id: variantIds });
                    return [2 /*return*/, next()];
            }
        });
    }); };
