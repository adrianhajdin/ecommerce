...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productId, optionId, _a, result, errors, product;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                productId = req.params.id;
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, helpers_1.refetchProduct)(productId, req.scope, req.remoteQueryConfig.fields)];
            case 2:
                product = _b.sent();
...
var DELETE = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var productId, optionId, errors, product;
