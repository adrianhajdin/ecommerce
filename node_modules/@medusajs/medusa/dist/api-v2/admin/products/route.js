...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, selectFields, queryObject, _a, products, metadata;
    var _b;
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var input, _a, result, errors, product;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, helpers_1.refetchProduct)(result[0].id, req.scope, req.remoteQueryConfig.fields)];
            case 2:
                product = _b.sent();
