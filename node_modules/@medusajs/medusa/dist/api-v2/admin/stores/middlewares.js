...
exports.adminStoreRoutesMiddlewares = [
    ...
    },
    {
        ...
        matcher: "/admin/stores",
        middlewares: [
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetStoresParams, QueryConfig.listTransformQueryConfig),
        ],
    },
    {
        method: ["GET"],
        ...
        middlewares: [
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetStoreParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        method: ["POST"],
        matcher: "/admin/stores/:id",
        middlewares: [
            (0, validate_body_1.validateAndTransformBody)(validators_1.AdminUpdateStore),
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetStoreParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
];
