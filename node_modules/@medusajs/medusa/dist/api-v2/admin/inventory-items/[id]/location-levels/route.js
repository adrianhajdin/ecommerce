...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, workflow, errors, inventoryItem;
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, workflow.run({
                        input: {
                            inventory_levels: [
                                __assign(__assign({}, req.validatedBody), { inventory_item_id: id }),
                            ],
                        },
                        throwOnError: false,
                    })];
...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, query, _a, inventory_levels, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), inventory_levels = _a.rows, metadata = _a.metadata;
                res.status(200).json({
