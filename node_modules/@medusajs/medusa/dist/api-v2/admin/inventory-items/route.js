...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, core_flows_1.createInventoryItemsWorkflow)(req.scope).run({
                    input: { items: [req.validatedBody] },
                })];
            case 1:
                result = (_a.sent()).result;
                return [4 /*yield*/, (0, helpers_1.refetchInventoryItem)(result[0].id, req.scope, req.remoteQueryConfig.fields)];
            case 2:
