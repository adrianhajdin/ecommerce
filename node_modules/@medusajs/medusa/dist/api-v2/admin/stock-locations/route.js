...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, core_flows_1.createStockLocationsWorkflow)(req.scope).run({
                    input: { locations: [req.validatedBody] },
                })];
            case 1:
                result = (_a.sent()).result;
                return [4 /*yield*/, (0, helpers_1.refetchStockLocation)(result[0].id, req.scope, req.remoteQueryConfig.fields)];
            case 2:
...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, _a, stock_locations, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), stock_locations = _a.rows, metadata = _a.metadata;
                res.status(200).json({
