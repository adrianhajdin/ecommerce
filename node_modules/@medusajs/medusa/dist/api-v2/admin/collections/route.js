...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, query, _a, collections, metadata;
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var input, _a, result, errors, collection;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                input = [
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, helpers_1.refetchCollection)(result[0].id, req.scope, req.remoteQueryConfig.fields)];
            case 2:
                collection = _b.sent();
