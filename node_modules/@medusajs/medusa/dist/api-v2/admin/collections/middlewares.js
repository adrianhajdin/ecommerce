...
exports.adminCollectionRoutesMiddlewares = [
    ...
    },
    {
        ...
        matcher: "/admin/collections",
        middlewares: [
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetCollectionsParams, QueryConfig.listTransformQueryConfig),
        ],
    },
    {
        method: ["GET"],
        ...
        middlewares: [
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetCollectionParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        method: ["POST"],
        matcher: "/admin/collections",
        middlewares: [
            (0, validate_body_1.validateAndTransformBody)(validators_1.AdminCreateCollection),
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetCollectionParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        ...
        matcher: "/admin/collections/:id",
        middlewares: [
            (0, validate_body_1.validateAndTransformBody)(validators_1.AdminUpdateCollection),
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetCollectionParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
