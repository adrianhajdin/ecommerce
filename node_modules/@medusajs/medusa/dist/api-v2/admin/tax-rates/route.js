...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, result, errors, taxRate;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, (0, core_flows_1.createTaxRatesWorkflow)(req.scope).run({
                    input: [
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, helpers_1.refetchTaxRate)(result[0].id, req.scope, req.remoteQueryConfig.fields)];
            case 2:
                taxRate = _b.sent();
...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, _a, tax_rates, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                _a = _b.sent(), tax_rates = _a.rows, metadata = _a.metadata;
                res.status(200).json({
                    tax_rates: tax_rates,
