...
exports.adminFulfillmentsRoutesMiddlewares = [
    ...
    },
    {
        ...
        middlewares: [
            (0, validate_body_1.validateAndTransformBody)(validators_1.AdminCancelFulfillment),
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminFulfillmentParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        method: ["POST"],
        matcher: "/admin/fulfillments",
        middlewares: [
            (0, validate_body_1.validateAndTransformBody)(validators_1.AdminCreateFulfillment),
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminFulfillmentParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        ...
        middlewares: [
            (0, validate_body_1.validateAndTransformBody)(validators_1.AdminCreateShipment),
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminFulfillmentParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
];
