...
var GET = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var remoteQuery, query, _a, customer_groups, metadata;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), customer_groups = _a.rows, metadata = _a.metadata;
                res.json({
...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var createGroups, customersData, _a, result, errors, customerGroup;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, helpers_1.refetchCustomerGroup)(result[0].id, req.scope, req.remoteQueryConfig.fields)];
            case 2:
