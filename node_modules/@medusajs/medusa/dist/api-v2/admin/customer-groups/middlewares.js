...
exports.adminCustomerGroupRoutesMiddlewares = [
    ...
    },
    {
        ...
        matcher: "/admin/customer-groups",
        middlewares: [
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetCustomerGroupsParams, QueryConfig.listTransformQueryConfig),
        ],
    },
    {
        method: ["GET"],
        ...
        middlewares: [
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetCustomerGroupParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        method: ["POST"],
        matcher: "/admin/customer-groups",
        middlewares: [
            (0, validate_body_1.validateAndTransformBody)(validators_1.AdminCreateCustomerGroup),
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetCustomerGroupParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
        ...
        matcher: "/admin/customer-groups/:id",
        middlewares: [
            (0, validate_body_1.validateAndTransformBody)(validators_1.AdminUpdateCustomerGroup),
            (0, validate_query_1.validateAndTransformQuery)(validators_1.AdminGetCustomerGroupParams, QueryConfig.retrieveTransformQueryConfig),
        ],
    },
    {
