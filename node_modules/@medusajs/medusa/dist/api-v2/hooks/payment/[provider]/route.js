...
var POST = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var provider, options, event_1, eventBus, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                provider = req.params.provider;
                options = req.scope.resolve(modules_sdk_1.ModuleRegistrationName.PAYMENT).options || {};
                event_1 = {
                    provider: provider,
                ...
                return [4 /*yield*/, eventBus.emit(utils_1.PaymentWebhookEvents.WebhookReceived, event_1, {
