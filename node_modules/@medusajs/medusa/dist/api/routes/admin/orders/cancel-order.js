...
exports.AdminPostOrdersOrderCancel = void 0;
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, manager.transaction(function (transactionManager) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, orderService.withTransaction(transactionManager).cancel(id)];
...
var AdminPostOrdersOrderCancel = /** @class */ (function (_super) {
    __extends(AdminPostOrdersOrderCancel, _super);
    function AdminPostOrdersOrderCancel() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return AdminPostOrdersOrderCancel;
}(common_1.FindParams));
exports.AdminPostOrdersOrderCancel = AdminPostOrdersOrderCancel;
