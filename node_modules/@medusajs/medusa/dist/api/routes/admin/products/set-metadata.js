...
exports.AdminPostProductsProductMetadataReq = void 0;
var _1 = require(".");
...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, (0, validator_1.validator)(AdminPostProductsProductMetadataReq, req.body)];
            case 1:
                validated = _b.sent();
                ...
                return [4 /*yield*/, manager.transaction(function (transactionManager) { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0: return [4 /*yield*/, productService.withTransaction(transactionManager).update(id, {
                                        metadata: (_a = {}, _a[validated.key] = validated.value, _a),
                                    })];
...
var AdminPostProductsProductMetadataReq = /** @class */ (function () {
    ...
    ], AdminPostProductsProductMetadataReq.prototype, "key", void 0);
    __decorate([
        (0, class_validator_1.IsString)(),
        __metadata("design:type", String)
    ], AdminPostProductsProductMetadataReq.prototype, "value", void 0);
    return AdminPostProductsProductMetadataReq;
}());
exports.AdminPostProductsProductMetadataReq = AdminPostProductsProductMetadataReq;
