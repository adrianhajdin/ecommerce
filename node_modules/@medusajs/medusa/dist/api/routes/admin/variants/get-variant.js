...
exports.AdminGetVariantParams = void 0;
...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, productVariantService, pricingService, rawVariant, _a, variant;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                return [4 /*yield*/, productVariantService.retrieve(id, req.retrieveConfig)];
            case 1:
                rawVariant = _b.sent();
                return [4 /*yield*/, pricingService.setAdminVariantPricing([rawVariant])];
            case 2:
                _a = __read.apply(void 0, [_b.sent(), 1]), variant = _a[0];
                res.status(200).json({ variant: variant });
                return [2 /*return*/];
        }
    });
}); });
var AdminGetVariantParams = /** @class */ (function (_super) {
    __extends(AdminGetVariantParams, _super);
    function AdminGetVariantParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return AdminGetVariantParams;
}(common_1.FindParams));
exports.AdminGetVariantParams = AdminGetVariantParams;
