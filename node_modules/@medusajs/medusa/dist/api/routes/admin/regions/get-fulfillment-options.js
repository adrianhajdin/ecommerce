...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var region_id, fulfillmentProviderService, regionService, region, fpsIds, options;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                region = _a.sent();
                fpsIds = region.fulfillment_providers.map(function (fp) { return fp.id; }) || [];
                return [4 /*yield*/, fulfillmentProviderService.listFulfillmentOptions(fpsIds)];
            case 2:
                options = _a.sent();
                res.status(200).json({
...
//# sourceMappingURL=get-fulfillment-options.js.map