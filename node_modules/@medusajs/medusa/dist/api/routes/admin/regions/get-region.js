...
exports.AdminGetRegionsRegionParams = void 0;
...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var region_id, regionService, region;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                region_id = req.params.region_id;
                regionService = req.scope.resolve("regionService");
                return [4 /*yield*/, regionService.retrieve(region_id, req.retrieveConfig)];
            case 1:
                region = _a.sent();
...
var AdminGetRegionsRegionParams = /** @class */ (function (_super) {
    __extends(AdminGetRegionsRegionParams, _super);
    function AdminGetRegionsRegionParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return AdminGetRegionsRegionParams;
}(common_1.FindParams));
exports.AdminGetRegionsRegionParams = AdminGetRegionsRegionParams;
