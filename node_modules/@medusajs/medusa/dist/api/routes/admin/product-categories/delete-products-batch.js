...
exports.AdminDeleteProductCategoriesCategoryProductsBatchParams = exports.AdminDeleteProductCategoriesCategoryProductsBatchReq = void 0;
...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, validatedBody, productCategoryService, manager, productCategory;
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, manager.transaction(function (manager) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, productCategoryService.withTransaction(manager).removeProducts(id, validatedBody.product_ids.map(function (p) { return p.id; }))];
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, productCategoryService.retrieve(id, req.retrieveConfig)];
            case 2:
 ...
 *           type: string
 */
var AdminDeleteProductCategoriesCategoryProductsBatchReq = /** @class */ (function () {
    function AdminDeleteProductCategoriesCategoryProductsBatchReq() {
    }
    __decorate([
        (0, class_validator_1.IsArray)(),
        (0, class_validator_1.ValidateNested)({ each: true }),
        (0, class_transformer_1.Type)(function () { return product_category_1.ProductBatchProductCategory; }),
        __metadata("design:type", Array)
    ], AdminDeleteProductCategoriesCategoryProductsBatchReq.prototype, "product_ids", void 0);
    return AdminDeleteProductCategoriesCategoryProductsBatchReq;
}());
exports.AdminDeleteProductCategoriesCategoryProductsBatchReq = AdminDeleteProductCategoriesCategoryProductsBatchReq;
// eslint-disable-next-line max-len
var AdminDeleteProductCategoriesCategoryProductsBatchParams = /** @class */ (function (_super) {
    __extends(AdminDeleteProductCategoriesCategoryProductsBatchParams, _super);
    function AdminDeleteProductCategoriesCategoryProductsBatchParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return AdminDeleteProductCategoriesCategoryProductsBatchParams;
}(common_1.FindParams));
exports.AdminDeleteProductCategoriesCategoryProductsBatchParams = AdminDeleteProductCategoriesCategoryProductsBatchParams;
//# sourceMappingURL=delete-products-batch.js.map