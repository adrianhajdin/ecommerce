...
exports.AdminGetProductCategoryParams = void 0;
...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, productCategoryService, productCategory;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                productCategoryService = req.scope.resolve("productCategoryService");
                return [4 /*yield*/, productCategoryService.retrieve(id, {
                        relations: _1.defaultAdminProductCategoryRelations,
                    })];
            case 1:
...
var AdminGetProductCategoryParams = /** @class */ (function (_super) {
    __extends(AdminGetProductCategoryParams, _super);
    function AdminGetProductCategoryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return AdminGetProductCategoryParams;
}(common_1.FindParams));
exports.AdminGetProductCategoryParams = AdminGetProductCategoryParams;
