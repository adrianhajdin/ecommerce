...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var taxProviderService, taxProviders;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                taxProviderService = req.scope.resolve("taxProviderService");
                return [4 /*yield*/, taxProviderService.list()];
            case 1:
                taxProviders = _a.sent();
                res.status(200).json({ tax_providers: taxProviders });
                return [2 /*return*/];
        }
    });
}); });
//# sourceMappingURL=list-tax-providers.js.map