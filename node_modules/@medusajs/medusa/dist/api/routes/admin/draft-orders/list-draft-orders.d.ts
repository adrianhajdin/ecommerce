...
declare const AdminGetDraftOrdersParams_base: import("../../../..").ClassConstructor<import("../../../../types/common").FindParams & import("../../../../types/common").FindPaginationParams>;
/**
 * Parameters used to filter and configure the pagination of the retrieved draft orders.
 */
export declare class AdminGetDraftOrdersParams extends AdminGetDraftOrdersParams_base {
    /**
