...
exports.AdminDeleteSalesChannelsChannelProductsBatchReq = void 0;
...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var validatedBody, id, salesChannelService, manager, salesChannel;
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, salesChannelService
                                        ...
                                        .removeProducts(id, validatedBody.product_ids.map(function (p) { return p.id; }))];
 ...
 *           type: string
 */
var AdminDeleteSalesChannelsChannelProductsBatchReq = /** @class */ (function () {
    function AdminDeleteSalesChannelsChannelProductsBatchReq() {
    }
    __decorate([
    ...
    ], AdminDeleteSalesChannelsChannelProductsBatchReq.prototype, "product_ids", void 0);
    return AdminDeleteSalesChannelsChannelProductsBatchReq;
}());
exports.AdminDeleteSalesChannelsChannelProductsBatchReq = AdminDeleteSalesChannelsChannelProductsBatchReq;
