        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, manager.transaction(function (transactionManager) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, noteService.withTransaction(transactionManager).delete(id)];
            ...
            case 1:
                _a.sent();
                res.status(200).json({ id: id, object: "note", deleted: true });
                return [2 /*return*/];
        }
    });
}); });
