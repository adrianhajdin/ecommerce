...
exports.AdminPostPublishableApiKeySalesChannelsBatchReq = void 0;
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, publishableApiKeyService
                                        ...
                                        .addSalesChannels(id, validatedBody.sales_channel_ids.map(function (p) { return p.id; }))];
                                case 1:
                                    _a.sent();
 ...
 */
var AdminPostPublishableApiKeySalesChannelsBatchReq = /** @class */ (function () {
    function AdminPostPublishableApiKeySalesChannelsBatchReq() {
    }
    __decorate([
    ...
    ], AdminPostPublishableApiKeySalesChannelsBatchReq.prototype, "sales_channel_ids", void 0);
    return AdminPostPublishableApiKeySalesChannelsBatchReq;
}());
exports.AdminPostPublishableApiKeySalesChannelsBatchReq = AdminPostPublishableApiKeySalesChannelsBatchReq;
//# sourceMappingURL=add-channels-batch.js.map