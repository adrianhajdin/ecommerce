...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, swapService, swap;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                swapService = req.scope.resolve("swapService");
                return [4 /*yield*/, swapService.retrieve(id, {
                        select: _1.defaultAdminSwapFields,
                        relations: _1.defaultAdminSwapRelations,
                    })];
            case 1:
                swap = _a.sent();
                res.json({ swap: swap });
...
//# sourceMappingURL=get-swap.js.map