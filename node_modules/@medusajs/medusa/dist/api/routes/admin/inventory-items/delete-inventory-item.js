...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, inventoryService, productVariantInventoryService, manager;
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, manager.transaction(function (transactionManager) { return __awaiter(void 0, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, productVariantInventoryService
                                        .withTransaction(transactionManager)
                                        .detachInventoryItem(id)];
                                case 1:
                                    _a.sent();
                                    return [4 /*yield*/, inventoryService.deleteInventoryItem(id)];
                                case 2:
                                    _a.sent();
                                    return [2 /*return*/];
                            }
...
//# sourceMappingURL=delete-inventory-item.js.map