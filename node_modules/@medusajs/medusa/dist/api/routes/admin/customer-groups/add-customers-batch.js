...
exports.AdminPostCustomerGroupsGroupCustomersBatchReq = void 0;
...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, (0, validator_1.validator)(AdminPostCustomerGroupsGroupCustomersBatchReq, req.body)];
            case 1:
                validated = _a.sent();
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, customerGroupService
                                        ...
                                        .addCustomers(id, validated.customer_ids.map(function (_a) {
                                        var id = _a.id;
                                        return id;
                                    }))];
...
//# sourceMappingURL=add-customers-batch.js.map