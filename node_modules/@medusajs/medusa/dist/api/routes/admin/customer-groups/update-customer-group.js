...
exports.AdminPostCustomerGroupsGroupReq = void 0;
...
exports.default = (function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, validatedBody, validatedQuery, customerGroupService, manager, expandFields, findConfig, customerGroup;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.params.id;
                return [4 /*yield*/, (0, validator_1.validator)(AdminPostCustomerGroupsGroupReq, req.body)];
            case 1:
            ...
            case 3:
                ...
                findConfig = {
                    relations: expandFields.length
                        ? expandFields
                        : _1.defaultAdminCustomerGroupsRelations,
                };
                return [4 /*yield*/, customerGroupService.retrieve(id, findConfig)];
            case 4:
