    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, validator_1.validator)(create_session_1.StorePostAuthReq, req.body)];
            case 1:
                validated = _a.sent();
            ...
            case 2:
                ...
                if (result.success && result.customer) {
                    token = jsonwebtoken_1.default.sign({ customer_id: result.customer.id, domain: "store" }, jwt_secret, {
                        expiresIn: "30d",
                    });
