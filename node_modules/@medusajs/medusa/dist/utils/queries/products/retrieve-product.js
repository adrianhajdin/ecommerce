...
exports.retrieveProduct = void 0;
var utils_1 = require("@medusajs/utils");
function retrieveProduct(container, id, remoteQueryObject) {
    var _a;
    if (remoteQueryObject === void 0) { remoteQueryObject = {}; }
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    variables = { id: id };
                    query = {
                        product: __assign({ __args: variables }, remoteQueryObject),
                    };
...
//# sourceMappingURL=retrieve-product.js.map