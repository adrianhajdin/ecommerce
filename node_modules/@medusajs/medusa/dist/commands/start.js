...
function default_1(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        function start() {
            return __awaiter(this, void 0, void 0, function () {
                var app, _a, dbConnection, shutdown_1, prepareShutdown_1, serverActivity_1, server_1, gracefulShutDown, err_1;
                var _this = this;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            _a = _b.sent(), dbConnection = _a.dbConnection, shutdown_1 = _a.shutdown, prepareShutdown_1 = _a.prepareShutdown;
                            ...
                            gracefulShutDown = function () {
                                logger_1.default.info("Gracefully shutting down server");
                                server_1
                                    .shutdown()
                                    .then(function () { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, prepareShutdown_1()];
