 ...
 */
export type TParsedPriceListImportRowData = Record<string, string | number | (string | number | object)[]>;
 ...
 */
export type PriceListImportCsvSchema = CsvSchema<TParsedPriceListImportRowData, TBuiltPriceListImportLine>;
/**
