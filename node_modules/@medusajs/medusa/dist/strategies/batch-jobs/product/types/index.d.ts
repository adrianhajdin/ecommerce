...
export type ProductExportDescriptor = {
    ...
    accessor: (variant: ProductVariant, context?: {
        product?: Product;
    }) => string;
 ...
 */
export type ProductImportCsvSchema = CsvSchema<TParsedProductImportRowData, TBuiltProductImportLine>;
/**
 ...
 */
export type TParsedProductImportRowData = Record<string, string | number | object | undefined | (string | number | object)[]>;
/**
 * CSV parser's row reducer result data shape.
 */
export type TBuiltProductImportLine = Record<string, any>;
export type ProductImportDescriptor = CsvSchemaColumn<TParsedProductImportRowData, TBuiltProductImportLine, true>;
