...
var CustomShippingOptionService = /** @class */ (function (_super) {
    ...
    function CustomShippingOptionService(_a) {
        var customShippingOptionRepository = _a.customShippingOptionRepository;
        var _this = 
    ...
    CustomShippingOptionService.prototype.retrieve = function (id, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var customShippingOptionRepo, query, customShippingOption;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        customShippingOptionRepo = this.activeManager_.withRepository(this.customShippingOptionRepository_);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, customShippingOptionRepo.find(query)];
     ...
     */
    CustomShippingOptionService.prototype.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var customShippingOptionRepo, data_, customShippingOptions, shippingOptions;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        customShippingOptionRepo = this.activeManager_.withRepository(this.customShippingOptionRepository_);
                        data_ = (Array.isArray(data) ? data : [data]);
                        customShippingOptions = customShippingOptionRepo.create(data_);
                        return [4 /*yield*/, customShippingOptionRepo.save(customShippingOptions)];
                    case 1:
