...
exports.CartRepository = database_1.dataSource.getRepository(models_1.Cart).extend({
    findWithRelations: function (relations, optionsWithoutRelations) {
        if (relations === void 0) { relations = {}; }
        if (optionsWithoutRelations === void 0) { optionsWithoutRelations = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var entities, entitiesIds, groupedRelations, entitiesIdsWithRelations, entitiesAndRelations;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        groupedRelations = (0, repository_1.getGroupedRelations)((0, utils_1.objectToStringPath)(relations));
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, (0, repository_1.mergeEntitiesWithRelations)(entitiesAndRelations)];
                }
            });
        });
    },
...
exports.default = exports.CartRepository;
