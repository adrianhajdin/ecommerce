...
exports.ProductCollectionRepository = database_1.dataSource
    .getRepository(models_1.ProductCollection)
    .extend({
                ...
                switch (_a.label) {
                    case 0:
                        qb = this.createQueryBuilder("pc")
                            ...
                            .innerJoin("discount_condition_product_collection", "dc_pc", "dc_pc.product_collection_id = pc.id AND dc_pc.condition_id = :dcId", { dcId: conditionId });
