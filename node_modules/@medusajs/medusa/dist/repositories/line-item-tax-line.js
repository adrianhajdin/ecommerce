...
exports.LineItemTaxLineRepository = void 0;
var models_1 = require("../models");
var database_1 = require("../loaders/database");
exports.LineItemTaxLineRepository = database_1.dataSource
    .getRepository(models_1.LineItemTaxLine)
    .extend({
                ...
                switch (_a.label) {
                    case 0:
                        qb = this.createQueryBuilder("line")
                            ...
                            .innerJoin("cart", "c", "i.cart_id = :cartId AND c.completed_at is NULL", { cartId: cartId });
...
exports.default = exports.LineItemTaxLineRepository;
