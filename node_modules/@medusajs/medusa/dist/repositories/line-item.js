...
exports.LineItemRepository = void 0;
var line_item_1 = require("../models/line-item");
var return_item_1 = require("../models/return-item");
var database_1 = require("../loaders/database");
exports.LineItemRepository = database_1.dataSource.getRepository(line_item_1.LineItem).extend({
    /**
     ...
     */
    findByReturn: function (returnId) {
                ...
                switch (_a.label) {
                    case 0:
                        qb = this.createQueryBuilder("li")
                            ...
                            .leftJoinAndMapOne("li.return_item", return_item_1.ReturnItem, "ri", "ri.item_id = li.id")
                            .where("ri.return_id = :returnId", { returnId: returnId });
...
exports.default = exports.LineItemRepository;
