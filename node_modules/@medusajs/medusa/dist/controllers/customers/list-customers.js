...
var listAndCount = function (scope, query, body) { return __awaiter(void 0, void 0, void 0, function () {
    var validatedQueryParams, customerService, expandFields, orderBy, order, direction, field, listConfig, filterableFields, _a, customers, count;
    var _b;
        ...
        switch (_c.label) {
            ...
            case 1:
                ...
                if (validatedQueryParams.order) {
                    order = validatedQueryParams.order;
