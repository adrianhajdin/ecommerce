 ...
 */
export declare abstract class AbstractTaxService extends TransactionBaseService implements ITaxService {
    protected readonly container: Record<string, unknown>;
    protected readonly config?: Record<string, unknown> | undefined;
    /**
     * @ignore
     */
    static _isTaxService: boolean;
    protected static identifier: string;
    /**
     * @ignore
     */
    static isTaxService(object: any): boolean;
    /**
    ...
    abstract getTaxLines(itemLines: ItemTaxCalculationLine[], shippingLines: ShippingTaxCalculationLine[], context: TaxCalculationContext): Promise<ProviderTaxLine[]>;
}
