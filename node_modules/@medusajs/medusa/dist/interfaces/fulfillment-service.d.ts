 ...
 */
export declare abstract class AbstractFulfillmentService extends TransactionBaseService implements FulfillmentService {
     ...
     * @ignore
     */
    static isFulfillmentService(object: any): boolean;
    /**
