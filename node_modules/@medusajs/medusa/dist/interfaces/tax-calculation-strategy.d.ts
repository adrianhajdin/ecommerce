 ...
 */
export declare abstract class AbstractTaxCalculationStrategy extends TransactionBaseService implements ITaxCalculationStrategy {
    protected readonly container: Record<string, unknown>;
    protected readonly config?: Record<string, unknown> | undefined;
    /**
     * @ignore
     */
    static _isTaxCalculationStrategy: boolean;
    /**
     * @ignore
     */
    static isTaxCalculationStrategy(object: any): boolean;
    /**
    ...
    abstract calculate(items: LineItem[], taxLines: (ShippingMethodTaxLine | LineItemTaxLine)[], calculationContext: TaxCalculationContext): Promise<number>;
}
