...
import { BaseFilterable, FilterQuery, FindOptions, FilterQuery as InternalFilterQuery, UpsertWithReplaceConfig } from "./index";
/**
...
export interface RepositoryService<T = any> extends BaseRepositoryService<T> {
     ...
     */
    softDelete(idsOrFilter: string[] | InternalFilterQuery, context?: Context): Promise<[T[], Record<string, unknown[]>]>;
    ...
    upsertWithReplace(data: any[], config?: UpsertWithReplaceConfig<T>, context?: Context): Promise<T[]>;
}
