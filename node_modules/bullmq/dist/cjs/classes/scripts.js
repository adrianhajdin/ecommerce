...
class Scripts {
    ...
    async addJobScheduler(jobSchedulerId, nextMillis, opts) {
        ...
        return client.addJobScheduler(keys.concat(args));
    }
    async updateRepeatableJobMillis(client, customKey, nextMillis, legacyCustomKey) {
        ...
        return client.updateRepeatableJobMillis(args);
    }
    ...
    async removeJobScheduler(jobSchedulerId) {
        ...
        return client.removeJobScheduler(keys.concat(args));
    }
    ...
    async remove(jobId, removeChildren) {
        ...
        const result = await client.removeJob(args);
        if (result < 0) {
            throw this.finishedErrors({
                code: result,
                jobId,
