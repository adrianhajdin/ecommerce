...
describe('AsYouType.getNumberValue()', function () {
  ...
  it('should not choose `defaultCountry` over the "main" one when both the `defaultCountry` and the "main" one match the phone number', function () {
    ...
    formatter.getNumber().country.should.equal('US'); // This phone number is specific to CA.

    var formatter2 = new AsYouType('US');
    formatter2.input('4389999999');
    formatter2.getNumber().country.should.equal('CA'); // This phone number doesn't belong neither to CA nor to US.
